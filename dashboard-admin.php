        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    <li>
                        <a href="#" data-toggle="collapse" data-target="#submenu-1" class="collasped"><i class="fa fa-fw fa-search"></i>
                            MENU 1 <i class="fa fa-fw fa-angle-down pull-right"></i></a>
                        <ul id="submenu-1" class="collapse" style="height:120px;">
                            <li style="#fff;"><a href="#" style="#fff;"><i class="fa fa-angle-double-right"></i> SUBMENU
                                    1.1</a></li>
                    ...
                    <li>
                        <a href="#" data-toggle="collapse" data-target="#submenu-2"><i class="fa fa-fw fa-star"></i>
                            MENU 2 <i class="fa fa-fw fa-angle-down pull-right"></i></a>

...
<head>
    ...
    <title>BloodHound || Admin-Delete-User</title>
...
<body class="register" style="background-image: url(img/deleteusers.jpg)">
    <?php
    ...
    <div class="signup-form">
        ...
        <h2 style="text-align: center;">Delete User</h2>
            <p style="font-family: 'Playfair Display', serif; color: #DF1F2D; text-align: center;">Erase this user from this website!</p>

...
<head>
    ...
    <title>BloodHound || Admin-Delete-County</title>
    <link rel="shortcut icon" href="bloodhound.ico"/>
...
<body class="register" style="background-image: url(img/county.gif)">
    ...
    <div class="signup-form">
        ...
        <h2 style="text-align: center;">Delete A County</h2>
            <p style="font-family: 'Playfair Display', serif; color: #DF1F2D; text-align: center;">Erase this county from this website!</p>
